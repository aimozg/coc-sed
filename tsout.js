...
var Creature = (function (_super) {
	...
	Creature.prototype.countCocksOfType = function () {
		...
		return this.cocks.filter(function (c) {
			return types.indexOf(c.cockType) >= 0;
		}).length;
	};
...
var Player = (function (_super) {
	...
	Player.prototype.bodyType = function () {
		var desc = "";
		var _a = this, thickness = _a.thickness, tone = _a.tone, gender = _a.gender, hipRating = _a.hipRating,
			buttRating = _a.buttRating;
		//OLD STUFF
		//SUPAH THIN
		if (thickness < 10) {
			//SUPAH BUFF
	...
	Player.prototype.demonScore = function () {
		var demonCounter = 0;
		var _a = this, hornType = _a.hornType, horns = _a.horns, tailType = _a.tailType, wingType = _a.wingType,
			faceType = _a.faceType, cor = _a.cor, lowerBody = _a.lowerBody;
	...
	Player.prototype.goblinScore = function () {
		var _a = this, earType = _a.earType, faceType = _a.faceType, lowerBody = _a.lowerBody, tallness = _a.tallness,
			skinTone = _a.skinTone;
		var horseCounter = 0;
		if (earType == 4)
			horseCounter++;
	...
	Player.prototype.nagaScore = function () {
		var _a = this, wingType = _a.wingType, faceType = _a.faceType, tongueType = _a.tongueType,
			antennae = _a.antennae;
		var nagaCounter = 0;
		if (faceType == 5)
			nagaCounter++;
		if (tongueType == 1)
	...
	Player.prototype.bunnyScore = function () {
		var _a = this, earType = _a.earType, tailType = _a.tailType, wingType = _a.wingType, faceType = _a.faceType,
			lowerBody = _a.lowerBody, antennae = _a.antennae, balls = _a.balls;
		var bunnyCounter = 0;
		if (faceType == 8)
			bunnyCounter++;
		if (tailType == 10)
	...
	Player.prototype.harpyScore = function () {
		var _a = this, earType = _a.earType, tailType = _a.tailType, wingType = _a.wingType, faceType = _a.faceType,
			lowerBody = _a.lowerBody, armType = _a.armType, hairType = _a.hairType;
		var harpy = 0;
		if (armType == 1)
			harpy++;
		if (hairType == 1)
